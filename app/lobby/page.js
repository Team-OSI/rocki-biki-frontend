      ...
      <div className="mt-16 px-7 gap-3 flex w-full max-w-screen-xl mb-4">
        ...
        <div className="w-1/3 flex flex-col gap-4 overflow-y-auto mb-1">
          ...
          <div className="p-6 bg-gray-100 bg-opacity-85 rounded-lg shadow-lg h-50vh">
            ...
            <input
              className="border border-gray-300 py-2 px-2 text-lg rounded-lg w-full h-12 mb-4"
        ...
        <div
          ...
          <h2 className="text-gray-800 text-4xl text-center font-bold mb-4">Find rooms</h2>
          <div className="relative mb-4 w-full">
            <input
              className="border border-gray-300 text-lg text-gray-800 py-2 pl-3 pr-10 rounded-lg w-full h-12"
